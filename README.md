...
**新增**：英文界面（英文设备开箱即用，设置页可切 跟随系统 / 中文 / English）· 多账号数据隔离 + 「账号一览」页

**修复**：进度条永远走不满（冻结 / 排除的不再计入分母）· 「排除的 bot」现在真正停签（原来只挡学习）·
冻结条目与排除条目视觉统一（虚化 + 沉底）· 签到倒计时 / 署名 / 诊断页 / 弹窗按钮 / 日志筛选等一批英文漏译

### v1.5.6 (119) — 2026-09-22

**新增**：三层黑名单（排除规则 / 排除的 bot / 目标冻结）· 排除管理独立入口 · 网络学习需确认 · 目标备注名 + @username · bot 矢量图标

**修复**：官方版 / Nagram 按钮学习失效（改结构匹配 hook）· 回调签到前置命令后盲等导致面板过期 · 网络层学习 hash 字段崩溃
